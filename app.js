...
const LAT = 52.4555; 
const LON = -1.7289;
const BUS_STOP_ID = "43000170202"; // Morris Way (Northbound)
...
function updateChronometer() {
  ...
  // Shift Schedule Limits (07:30 - 16:00)
...
// ==========================================
// MODULE 04: EXTRACTION VECTOR (TRANSIT DETECTOR)
// ==========================================
async function fetchTransit() {
  try {
    const targetUrl = `https://transportapi.com/v3/uk/bus/stop/${BUS_STOP_ID}/live.json?app_id=741002cf&app_key=2c9a92025eb270a43063548325a7a922&group=no&nextbuses=no`;
    
    // Using a streamlined raw proxy to preserve JSON structure cleanly
